...
Modularity produces $34$ communities in the general relativity graph.  It is the smallest of the coauthor networks, but we begin to see the resolution limit of modularity.  A clear example of resolution limit is in Figure \ref{fig:rel_24}.  We provide visualizations of the largest community returned by each method.  Linearity and Parallel return several small dense and isolated communities.
...
\includegraphics[width=2.8in]{Figures/relativity_par_319_e_p}
\caption{The largest community produced by Parallel within $10$ forces at $94$ nodes.  Five subcommunities were created by parallel. The core of the community has $65$ nodes and $I(C) = 0.22$.}
\label{fig:rel_319}
\end{figure}
...
\caption{The largest community produced by Modularity with $234$ nodes. The most discernable difference is that the wiskers connected by two or fewer edges are broken off.  The core of the community has $80$ nodes and an internal density of $I(C) = 0.07$}
\label{fig:rel_3}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=4in]{Figures/relativity__csize}
...
\begin{figure}[!h]
\centering
\includegraphics[width=4in]{Figures/relativity_linear_parallel_n_communities}
...
Condensed Matter is the largest of the coauthor networks.  The properties found in the relativity network are found in the condensed matter network.

\begin{table}[!h]
\centering
\begin{tabular}{c|ccccc}
Communities From & $I(S)$ & $E(S)$ & $|S|$& Avg Diameter & Avg NCP \\ \hline
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.8in]{Figures/cond_mod_48_module}
\includegraphics[width=2.8in]{Figures/cond_mod_48_metis}
\includegraphics[width=2.8in]{Figures/cond_mod_48_linear}
\includegraphics[width=2.8in]{Figures/cond_mod_48_parallel}
\caption{Condensed Matter Coauthor network.  One of the smallest communities returned by Modularity with $103$ nodes.}
\label{fig:cond_48}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=4in]{Figures/cond__csize}
\includegraphics[width=4in]{Figures/cond_linear_parallel_n_communities}
\caption{The number of communities a node belongs to.  Follows a power law distribution.  Comes from the degree distribution.  The number of communities a node belongs to.}
\label{fig:condl_n_communities}
\end{figure}

\section{Physics ArchiveX}

Notes on the physics archive.

There is an anatomy to a community.

\begin{itemize}
\item Over time a larger precentage of citations come from outside communities - Modularity confirms
\item The more communities you are cited by the higher your citation rate. - Modularity does not confirm
\item The more communities you cite the lower your citation rate. - Modularity does not confirm
\item The anatomy of a highly cited paper : quick citations in home community, then a burst of citations from other communities?? expected number of citations per community
\end{itemize}

Can I find new communities - or tell what stage they are in ie need a review, need an interpretor
Can I tell when a community is up and coming and how long it will last?

Questions about review
\begin{itemize}
\item how many papers in a community before and after it?
\item how many communities do they cite from?
\end{itemize}


\begin{figure}[!h]
\centering
\includegraphics[width=4in]{Figures/correlation_c_cites_citations}
\caption{The number of communities that cite a paper and the number of citations received by a paper in the physics archive.  In Modularity the conclusion is that once you are cited by 20 communities, then you may become a highly cited paper.  In Parallel the conclusion is the more communities you are cited by, the more citations you will receive.}
\label{fig:archive_correlation}
\end{figure}

Belongs to a power law distribution of communities because of citations or cites?
